...
import random as r                           #En ocasiones hay que agregar esta línea para que trabaje el import
...
for i in range(1,n+1):                               # corremos el ciclo for de 1 a n+1, agregamos 1 a la frontera superior para que el conteo llegue hasta n.
    s=r.randint(1,6)                                   # generamos un número aleatorio entre 1 y 6,incluyendo los extremos, y con igual probabilidad de ocurrencia
